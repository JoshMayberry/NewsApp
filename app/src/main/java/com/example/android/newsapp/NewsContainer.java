...
/**
 * This holds data pertaining to news articles.
 * A list of this is generated by updating {@link NewsViewModel#containerList}
 * via {@link NewsViewModel#loadData()}, {@link NewsViewModel#resetData()}, or {@link NewsViewModel#restartData()}.
 * <p>
...
public class NewsContainer extends BaseObservable {
	...
	/**
	 * Dates are retrieved using {@link #dateImportFormat}, which is configured according to the JSON data returned by {@link NewsViewModel#getQuery}.
